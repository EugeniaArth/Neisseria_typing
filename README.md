...
3) Дополнительно (или вместо GATK) анализ  резистентности по алгоритму CARD для .fasta 
4) Аннотирование .fasta при помощи bakta https://github.com/oschwengers/bakta
5) Поиск ортологов (для всех ортологов скорее всего, а не для коровых?)
6) Построение идеального модельного дерева ИЛИ формулировка критериев кластеризации
7) Выравнивание и построение филогенетических деревьев с учетом п.5
